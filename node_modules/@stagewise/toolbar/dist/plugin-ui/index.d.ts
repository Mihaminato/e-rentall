...
export declare function Button({ children, variant, size, asChild, ...props }: ButtonProps): JSX.Element;
...
export declare function PanelContent({ children }: {
    children?: ReactNode;
}): JSX.Element;
...
export declare function PanelHeader({ title, description, }: {
    title?: string;
    description?: string;
}): JSX.Element;
