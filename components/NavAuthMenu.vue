<template>
  ...
  <div>
    ...
    <div v-if="!isLoggedIn" class="flex items-center gap-2">
      <NuxtLink to="/auth/login" class="btn btn-ghost">Connexion</NuxtLink>
      <NuxtLink to="/auth/register" class="btn btn-primary">S'inscrire</NuxtLink>
    </div>
    ...
    <div v-else class="dropdown dropdown-end">
      ...
      >
        <li class="menu-title">{{ fullName }}</li>
        <li><NuxtLink to="/profile" @click="closeMenu">Mon profil</NuxtLink></li>
        <li><NuxtLink to="/vehicles/my-vehicles" @click="closeMenu">Mes véhicules</NuxtLink></li>
        <li>
          <NuxtLink to="/bookings" @click="closeMenu">
            <Icon name="material-symbols:book-online-outline" class="mr-2" />
            Mes locations
          </NuxtLink>
        </li>
        <li>
          <NuxtLink to="/bookings/requests" @click="closeMenu">
            <Icon name="material-symbols:inbox" class="mr-2" />
        ...
        <template v-if="isAdmin">
          ...
          <li>
            <NuxtLink to="/admin" class="text-error font-semibold" @click="closeMenu">
        ...
        <div class="divider"></div>
        <li>
          <button class="btn btn-sm btn-ghost" :disabled="loading" @click="handleLogout">
