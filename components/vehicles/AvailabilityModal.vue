    ...
    <dialog :id="modalId" class="modal modal-bottom sm:modal-middle z-[9]">
      <div class="modal-box max-w-4xl">
        ...
        <div v-else class="py-2">
          ...
          <div v-if="ownerUnavailabilities.length > 0" class="mt-8">
            <h4 class="font-semibold mb-4 text-gray-700">
              Périodes d'indisponibilité définies ({{ ownerUnavailabilities.length }})
            </h4>

            <!-- Zone de scroll avec hauteur limitée -->
            <div class="max-h-[400px] overflow-y-auto pr-2 space-y-3">
              <div
                v-for="availability in ownerUnavailabilities"
                :key="availability.id"
              ...
              >
                ...
                <div class="flex-1">
                  ...
                  <div class="text-sm text-gray-600">
                    ...
                    <span
                      v-if="hasActiveBookingsForAvailability(availability)"
                ...
                <div class="flex items-center gap-1">
                  <button
                    ...
                    "
                    @click="updateAvailabilityItem(availability)"
                  >
...
<script setup lang="ts">
  ...
  const { formatDate, getDurationText, getTodayFormatted } = useCalendarDates()
  const {
    selectedStartDate,
    selectedEndDate,
    selectionError,
