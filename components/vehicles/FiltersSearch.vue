    ...
    <div class="card-body">
      ...
      <div class="collapse collapse-arrow border border-base-300 bg-base-200 rounded-box mt-2">
        ...
        <div class="collapse-content">
          ...
          <div class="flex flex-col gap-4 mt-6 md:hidden">
            <button class="btn btn-primary flex-grow" @click="applyFilters">
...
<script setup lang="ts">
  ...
  const transmissionOptions = [{ value: '', label: 'Toutes' }, ...TRANSMISSION_OPTIONS]
  const fuelTypeOptions = [{ value: '', label: 'Tous' }, ...FUEL_TYPE_OPTIONS]
